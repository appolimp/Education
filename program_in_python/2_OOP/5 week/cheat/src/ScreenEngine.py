...
class GameSurface(Screen_Handle):
    ...
    def draw(self, GD):
        # Расчет параметров отображения карты
        self.view_params()
        # Рисуем карту
        self.draw_map()
