...
class Autocad:
    ...
    def AddLine(self, startPoint, endPoint):
        ...
        """
        line = self.acad.ActiveDocument.ModelSpace.AddLine(
            startPoint, endPoint)
        return line
    ...
    def AddLwpline(self, *vertexCoord):
        ...
        """
        lwpline = self.acad.ActiveDocument.ModelSpace.AddLightWeightPolyline(
            VtVertex(*vertexCoord))
        return lwpline
    ...
    def AddCircle(self, centerPnt, radius):
        ...
        """
        circle = self.acad.ActiveDocument.ModelSpace.AddCircle(
            centerPnt, radius)
        return circle
    ...
    def AddArc(self, centerPnt, radius, startAngle, endAngle):
        ...
        """
        arc = self.acad.ActiveDocument.ModelSpace.AddArc(
            centerPnt, radius, AngleDtoR(startAngle), AngleDtoR(endAngle))
        return arc
    ...
    def AddSpline(self, *fitPoints, startTan=None, endTan=None):
        ...
        """
        spline = self.acad.ActiveDocument.ModelSpace.addSpline(
            VtVertex(*fitPoints), startTan, endTan)
        return spline
    ...
    def AddEllipse(self, centerPnt, majorAxis, radiusRatio):
        ...
        """
        ellipse = self.acad.ActiveDocument.ModelSpace.addEllipse(
            centerPnt, majorAxis, radiusRatio)
        return ellipse
    ...
    def AddHatch(self, patternType, patterName, associative, outLoopTuple, innerLoopTuple=None):
        ...
        """
        hatch = self.acad.ActiveDocument.ModelSpace.AddHatch(
            patternType, patterName, associative)
    ...
    def ActivateLinetype(self, typename):
        ...
        """
        try:
            self.acad.ActiveDocument.ActivateLinetype = self.acad.ActiveDocument.Linetypes.Item(
                typename)
        except:
    ...
    def GetCurrentUCS(self):
        ...
        if self.acad.ActiveDocument.GetVariable('ucsname') == '':
            ...
            currCS = self.acad.ActiveDocument.UserCoordinateSystems.Add(
                origin, xAxisPnt, yAxisPnt, 'currentUCS')
        else:
